...
sorted_down_3=sorted_down_3[49:101]
sorted_up_4=sorted_up_4[49:101]
...
#Amazon_Personal Care
import csv

f = open('amazon_reviews_us_Personal_Care_Appliances_v1_00.tsv','r',encoding='utf-8')
dataline = csv.reader(f,delimiter='\t')
data=list(dataline)
data=data[1:]
